...
#### Pagina Links
#### Luna Barreto
In questo seminario ho realizzato una pagina personale che combina HTML, CSS e JavaScript. Il design scuro e pulito presenta un logo, un'introduzione e collegamenti ai miei profili social e al mio Portfolio. Un script JavaScript aggiorna dinamicamente la data e l'orario, personalizzando il saluto in base al giorno della settimana. Il progetto dimostra abilità nella creazione di pagine web interattive e visivamente coerenti.
